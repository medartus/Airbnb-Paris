...
def Mock32():     
    old = [
        [121,174629,'f','2017-01-02','2018-01-01',365,0,1125,'M21'],
    ]

    new = [
        [174629,'f','2017-02-07','2018-02-06',365,0,1125,'M21'],
    ]

    to_insert = [
        [174629,'f','2017-01-02','2018-02-06',401,0,1125,'M21'],
    ]
    to_delete = [121]
    return CreateMock(new, old, to_insert, to_delete)
...
def Mock33():     
    old = [
        [11158453,254063,'t','2017-01-24','2017-02-06',14,0,1125,'A'],
        [11158454,254063,'f','2017-02-07','2017-02-12',6,0,1125,'L7'],
        [11158455,254063,'t','2017-02-13','2018-01-03',325,0,1125,'A']
    ]

    new = [
        [254063,'f','2017-02-08','2017-02-12',5,0,1125,None],
        [254063,'t','2017-02-13','2017-02-13',1,0,1125,None],
        [254063,'f','2017-02-14','2017-02-26',13,0,1125,None],
        [254063,'t','2017-02-27','2017-02-27',1,0,1125,None],
        [254063,'f','2017-02-28','2017-03-02',3,0,1125,None],
        [254063,'t','2017-03-03','2017-05-17',76,0,1125,None],
        [254063,'f','2017-05-18','2017-05-21',4,0,1125,None],
        [254063,'t','2017-05-22','2018-02-07',262,0,1125,None]
    ]
...
"""def Mock34():
    old = [
        [16582561,16582560, "f", "2017-02-06", "2017-02-13", 8 , 0, 1125, "L14"],
        [16582562,16582560, "t", "2017-02-14", "2017-02-23", 10, 0, 1125, "A"],
        [16582563,16582560, "f", "2017-02-24", "2017-07-06", 133 , 0, 1125, "M21"],
        [16582564,16582560, "t", "2017-07-07", "2017-08-04", 29, 0, 1125, "A"],
        [16582565,16582560, "f", "2017-08-05", "2018-02-05", 185  , 0, 1125, "M21"]
    ]

    new = [
        [16582560,'f','2017-03-04','2017-08-26',176,0,1125,'M21'],
        [16582560,'f','2017-08-27','2017-08-31',5,0,1125,'A'],
        [16582560,'f','2017-09-01','2018-03-03',184,0,1125,'M21'],
    ]
    to_insert = [
